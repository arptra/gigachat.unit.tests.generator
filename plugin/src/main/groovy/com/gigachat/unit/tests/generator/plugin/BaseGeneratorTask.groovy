...
abstract class BaseGeneratorTask extends DefaultTask {
    ...
    void runGeneration() {
        ...
        props.setCoverage(propertiesConfig.coverage)
        props.setCoverageGoals(propertiesConfig.coverageGoals)
        props.setCoverageThreshold(propertiesConfig.coverageThreshold)
